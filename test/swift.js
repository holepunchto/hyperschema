...
test('swift: struct with single required uint — roundtrip', (t) => {
...
test('swift: basic struct, all required fields, no version bump', (t) => {
...
test('swift: basic struct, all required fields, version bump', (t) => {
...
test('swift: struct with multiple required uint fields — roundtrip', (t) => {
  const schema = Hyperschema.from(null)
  schema.namespace('test').register({
    name: 'test-struct',
    fields: [
